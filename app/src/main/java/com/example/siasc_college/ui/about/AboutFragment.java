package com.example.siasc_college.ui.about;
...
public class AboutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        list.add(new BranchModel(R.drawable.ic_mech,"MCA","This discipline of engineering in SSGPURC has the most lively and highly energized group of engineers. Students have left their mark in several premier institutes all over India including ITTs. Main difference lies in the approach of both the students and the faculty which knows exactly WHAT to achieve and HOW to achieve."));
        list.add(new BranchModel(R.drawable.ic_it,"COMMERCE","Information Technology is the study, design, development, application, implementation, support or management of computer-based information systems. In the era where there is demand for trained IT professionals this department provides the students with a good infrastructure and highly qualified faculty to produce skilled professionals."));
        list.add(new BranchModel(R.drawable.ic_ece,"TAMIL","Department of Electronics & Communication is one of the most sought after department of SSGPURC and boasts of excellent infrastructure. The students are motivated to take up challenging projects and enhance their practical skills in electronics. The department is well equipped in all aspects and has the following labs."));
